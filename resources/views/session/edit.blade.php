...
<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
    ...
    <div class="mb-3 pt-3 pb-2">
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center">
            <h2 class="h4">Chỉnh sửa thông tin phiên</h2>
        </div>

        <form class="needs-validation" novalidate action="/edit-session/events/{{ $inforEvent->slug }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row">
            ...
            <div class="row">
                <div class="col-12 col-lg-4 mb-3">
                    ...
                    <input type="text" class="form-control is-invalid" id="inputTitle" name="title" placeholder=""
                        value="">
